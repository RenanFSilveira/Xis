      ...
      <header className="bg-white py-3 px-6 shadow-sm sticky top-0 z-40">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-6">
            ...
            <a href="#profissao" className="text-gray-700 hover:text-emerald-600 transition-colors">
              A profissão
            </a>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="relative h-[400px] rounded-lg overflow-hidden shadow-xl bg-gray-100">
              <video controls className="w-full h-full object-cover" poster="/images/video-poster.jpg">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="#profissao" className="text-gray-300 hover:text-white transition-colors">
                    A profissão
                  </a>
                </li>
                <li>
