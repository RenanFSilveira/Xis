...
export default function DetailedInfoSection() {
  ...
  return (
    <>
      {/* Seção Principal */}
      <section id="detailed-info" className="py-20 px-6 bg-white">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <button
            onClick={openModal}
            className="inline-block bg-emerald-500 text-white px-8 py-3 rounded-md hover:bg-emerald-600 transition-colors font-semibold"
          >
            ...
            <div className="p-8">
              <div className="prose prose-lg max-w-none">
                ...
                <p className="text-gray-700 mb-6">
                  ...
                  software CAD odontológico, executando arranjo e tex turização com processo digital, trabalhos esses,
