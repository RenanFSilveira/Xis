...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Não! Nosso curso foi desenhado para formar profissionais do zero. O único pré-requisito é o Ensino Médio completo.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Sim! Você recebe um certificado de conclusão para cada módulo finalizado e um certificado completo de Especialista em Próteses Odontológicas ao término do curso, válido em todo o território nacional.",
  },
  {
    question: "Qual a duração total do curso?",
    answer: "A formação completa tem duração de 24 meses, dividida em 4 módulos independentes.",
  },
  {
    question: "Qual o valor do investimento?",
    answer: "A mensalidade do curso é R$800",
  },
  {
  ...
  },
  {
    ...
    answer: "Nossas instalações estão localizadas em Vitória, Espírito Santo. Av. Nossa Senhora da Penha.",
  },
  {
    question: "Há suporte para encontrar emprego após o curso?",
    answer:
      "Sim, oferecemos orientação de carreira e temos parcerias com laboratórios da região, facilitando a entrada dos nossos alunos no mercado de trabalho.",
  },
]
